...
export const getTimeSpaceData = (): MetricData[] => [
  {
    ...
    unit: '变异系数',
    trend: 0.0,
    definition: '不同行政区无人机飞行密度的变异系数（CV）。反映城市空中交通的地域平衡性。',
    insight: '南山区和宝安区飞行密度最高，主要集中在高新科技园区和物流枢纽。龙岗区和大鹏新区密度较低。',
    suggestion: '加大龙岗区、坪山区、大鹏新区等外围地区的无人机基础设施建设，提升区域平衡性。',
    chartType: 'Map',
    chartData: [
      { name: '南山区', value: 85 },
      { name: '福田区', value: 60 },
...
export const getInnovationData = (): MetricData[] => [
  ...
  },
  {
    ...
    unit: '熵值',
    trend: 0.05,
    definition: '不同高度层（0-120m, 120-300m, 300m+）飞行分布的均匀度。',
    insight: '空域分层良好。物流偏好100-150m，而测绘占据200m+。',
    suggestion: '保持0-50m净空，以减少居民区附近的噪音。',
    chartType: '3DBar',
    chartData: [
